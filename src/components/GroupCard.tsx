  ...
  return (
    <article className="flex flex-col rounded-2xl bg-white p-5 shadow-sm">
      ...
      <a
        ...
        className="mt-auto block rounded-xl bg-runnest-yellow py-2.5 text-center text-sm font-bold text-runnest-blue transition-colors hover:bg-runnest-yellow-light"
      >
        Kontakta gruppen
      </a>
    </article>
